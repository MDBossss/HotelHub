...
const Deals = () => {
	...
	const navigationSearchFilters: SearchFilters = location.state;
			...
			<div className="deals-wrapper container">
				...
				<div className="bar">
					<SearchBar
						...
						value={navigationSearchFilters?.destination && navigationSearchFilters.destination}
					/>
				</div>
				<div className="filters">
					...
					<div className="right">
						...
						<div className="sort">
							...
							{showList && (
								<div ref={dropdownRef}>
									<DropdownList values={sortOptions} onClicked={handleSort} className="list" />
								</div>
							)}
						</div>
					</div>
